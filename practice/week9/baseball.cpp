...
bool checkNumber(int firstNum, int secondNum, int thirdNum);
...
int main() {
	...
	while (1) {
		...
		if (checkNumber(firstNum, secondNum, thirdNum) == true) {
...
bool checkNumber(int firstNum, int secondNum, int thirdNum){
    ...
    while (1){
        ...
        if (userNumber > 1000 || userNumber < 10){
	...
	cout << guessFirst << guessSecond << guessThird << "의 결과 : " << strike << " 스트라이크, " << ball << "볼 입니다." << endl;
